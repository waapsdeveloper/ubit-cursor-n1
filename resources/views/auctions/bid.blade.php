                        ...
                        @else
                            @if(!$user->isBidder())
                                ...
                                <div class="text-center py-8">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Bidder Account Required</h3>
                                    <p class="text-gray-600 mb-6">You need a bidder account to place bids. Apply for bidder status to start bidding on auctions.</p>
                                    <div class="space-y-3">
                                        <a href="{{ route('bidder.application.show') }}" class="w-full bg-ubit-purple-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-ubit-purple-600 transition-colors block text-center">
